          ...
          <div className="relative z-10 grid gap-12 lg:grid-cols-[1.15fr_0.85fr]">
            <div className="space-y-10">
              <div className="space-y-5">
                ...
                <div className="space-y-4">
                  ...
                  <p className="max-w-xl text-base leading-relaxed text-foreground/70 md:text-lg">
                    Stream, discover, and share music with glassy interfaces, subtle motion, and immersive visuals that keep
              ...
              <div className="flex flex-col gap-4 pt-2 sm:flex-row">
                ...
                <Button size="lg" variant="outline" className="h-12 rounded-full px-8 text-base hover:bg-foreground/5">
                  View plans
                </Button>
              </div>
              ...
              <div className="grid gap-4 sm:grid-cols-1">
                {highlights.map((highlight) => (
                  ...
                  >
                    ...
                    <p className="text-sm leading-relaxed text-foreground/70">{highlight.description}</p>
                  </div>
                ))}
              </div>
            </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 space-y-4">
                    <div className="flex items-start justify-between gap-3">
                      <div>
                        <p className="text-xs uppercase tracking-[0.3em] text-foreground/60">Now playing</p>
                        <h3 className="mt-2 text-2xl font-semibold tracking-tight text-foreground">{activeTrack.title}</h3>
                      ...
                      >
                        <div
                          className={`flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full border border-border/40 text-sm font-semibold transition-colors ${
                            isActive ? "bg-foreground/20 text-foreground" : "bg-background/70 text-foreground/70"
                          }`}
                        >
                        ...
                        <div className="flex flex-1 items-center justify-between gap-4">
                          <div>
                            <p className="text-sm font-semibold text-foreground/90">{track.title}</p>
